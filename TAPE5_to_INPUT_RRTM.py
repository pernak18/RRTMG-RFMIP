...
if __name__ == '__main__':
  ...
  parser.add_argument('--profile_number', '-p', type=int, default=0, \
    help='RFMIP profile number to process. zero offset')
  ...
  with nc.Dataset(ncFile, 'r') as ncObj:
    surfaceT = np.array(ncObj.variables['surface_temperature'])[0, iProf]
  # endwith
